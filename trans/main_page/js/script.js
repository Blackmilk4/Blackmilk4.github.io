...
$('.menu_fix-itemSecond').on('click', function () {
	$('html,body').animate({
		scrollTop: $('.section_transportation').offset().top
	}, {
		duration: 3E2
	});
});
...
$('.menu_fix-itemThird').on('click', function () {
	$('html,body').animate({
		scrollTop: $('.section_escort').offset().top
	}, {
		duration: 3E2
	});
});
...
$('.menu_fix-itemFour').on('click', function () {
	$('html,body').animate({
		scrollTop: $('.section_app').offset().top
	}, {
		duration: 3E2
	});
});
...
$('.menu_fix-itemFive').on('click', function () {
	$('html,body').animate({
		scrollTop: $('.section_withUs').offset().top
	}, {
		duration: 3E2
	});
});
...
$('.menu_item-app').on('click', function () {
	$('html,body').animate({
		scrollTop: $('.section_tariffs').offset().top
	}, {
		duration: 3E2
	});
});
