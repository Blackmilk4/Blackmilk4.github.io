...
$('.title_applicationsMobile').click(function () {
	$('.title_applicationsMobile').toggleClass('img_top')
	$('.title_transportationMobile').removeClass('img_top')
});

$('.title_transportationMobile').click(function () {
	$('.title_transportationMobile').toggleClass('img_top')
	$('.title_applicationsMobile').removeClass('img_top')
});

$(document).ready(function () {
	$('.title_applicationsMobile').on('click', b_acc);
});

function b_acc() {
	$('.answer_boxMobile').not($(this).next()).slideUp(500);
	$(this).next().slideToggle(500);
}

$(document).ready(function () {
	$('.title_transportationMobile').on('click', b_acc2);
});
